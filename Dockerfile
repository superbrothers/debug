FROM curlimages/curl:8.5.0 AS curlbase
...
FROM ghcr.io/stern/stern:1.27.0 AS stern

FROM curlbase AS k9s
ARG TARGETARCH
# renovate: datasource=github-releases depName=derailed/k9s
ARG K9S_VERSION=v0.30.6
RUN set -x && \
